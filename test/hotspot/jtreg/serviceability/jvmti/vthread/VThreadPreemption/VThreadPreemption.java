...
* @enablePreview
*
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+IgnoreUnrecognizedVMOptions -XX:-VerifyContinuations VThreadPreemption
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+IgnoreUnrecognizedVMOptions -XX:-VerifyContinuations -Dsuspendresumer=true VThreadPreemption
*/
...
* @enablePreview
*
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+VerifyContinuations -Xint -Dsleeptime=3 VThreadPreemption
* @run main/othervm/native -agentlib:VThreadPreemption -XX:-VerifyContinuations -XX:-UseTLAB VThreadPreemption
*/
...
* @enablePreview
*
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+IgnoreUnrecognizedVMOptions -XX:-VerifyContinuations -Xcomp -XX:-TieredCompilation -XX:CompileOnly=jdk/internal/vm/Continuation,VThreadPreemption VThreadPreemption
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+IgnoreUnrecognizedVMOptions -XX:-VerifyContinuations -Xcomp -XX:TieredStopAtLevel=3 -XX:CompileOnly=jdk/internal/vm/Continuation,VThreadPreemption VThreadPreemption
*/
...
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+IgnoreUnrecognizedVMOptions -XX:-VerifyContinuations -XX:+AbortVMOnSafepointTimeout -XX:SafepointTimeoutDelay=180000 -XX:+FullGCALot -XX:FullGCALotInterval=1000 VThreadPreemption
*/
...
* @enablePreview
*
* @run main/othervm/native -agentlib:VThreadPreemption -XX:+VerifyContinuations -XX:+UseZGC -Dsleeptime=3 VThreadPreemption
*/
    ...
    private void foo2(long runTimeNanos) {
        ...
        while (System.nanoTime() - startTime < runTimeNanos) {
            ...
            for (int k = 1; k < 300; k++) {
                ...
                if (k % 10 == 0) {
                    System.out.println("iteration #" + k + "at time: " + System.nanoTime());
                }
            }
